GUIDELINES:
    ...
    - COMMERCIAL USE:
        ...
        - Derivative work can be paywalled. To do so, it must not include any images
          or footage that are present in the original work. (example: you can make
          fanart and paywall it)
