GUIDELINES:
    ...
    - COMMERCIAL USE:
        - Commercial use of the website/game is allowed, given appropriate credit and
          attention to the age rating (if any).
        - Do not sell merch of my characters without permission.
    ...
    - GAMES:
        - Do not redistribute the game files without permission. (If you wish to share
          ...
          artwork and sprites found in-game is allowed.)
    ...
    - ARTWORK:
        ...
        - Tracing is allowed non-commercially. Do not sell images that are traced from
          my work.
